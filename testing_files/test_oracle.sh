...
docker exec -ti exasoldb sh -c "curl -v -X PUT -T instantclient-basic-linux.x64-12.1.0.2.0.zip http://w:$pwd@127.0.0.1:8888/default/drivers/oracle/instantclient-basic-linux.x64-12.1.0.2.0.zip"
