...
PYTHONPATH=$HOME/exa_py/lib/python2.7/site-packages python create_script.py "postgres_to_exasol_v2.sql"
#this python script executes the export script created by the postgres_to_exasol_v2.sql script and creates an output.sql file with the result
PYTHONPATH=$HOME/exa_py/lib/python2.7/site-packages python export_res.py "POSTGRES_TO_EXASOL" "postgres_db" "%test%" "%"
