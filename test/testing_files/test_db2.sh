...
docker cp testing_files/db2_datatypes_test.sql db2db:/home/db2inst1/	
...
echo "create or replace CONNECTION db2_connection TO 'jdbc:db2://$ip:50000/sample' USER 'db2inst1' IDENTIFIED BY 'test123';" > testing_files/create_conn.sql
